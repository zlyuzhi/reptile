...
function(e, t) { !
    function(e, t) {
        ...
        ie = function(e) {
            ...
            e), xe.call(this, t), "copy" === e.type && (n = (r = De(z)).data, B = r.formatMap), n)
        },
        oe = function() {
            var e = K.swfPath || "",
            t = e.slice(0, 2),
        ...
        Te = function(e) {
            ...
            case "beforecopy":
                ...
                break;
            case "copy":
                var l, c, u = e.relatedTarget; ! z["text/html"] && !z["text/plain"] && u && (c = u.value || u.outerHTML || u.innerHTML) && (l = u.value || u.textContent || u.innerText) ? (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l), c !== l && e.clipboardData.setData("text/html", c)) : !z["text/plain"] && e.target && (l = e.target.getAttribute("data-clipboard-text")) && (e.clipboardData.clearData(), e.clipboardData.setData("text/plain", l));
                break;
            case "aftercopy":
                _e(e),
                Ke.clearData(),
        ...
        Se = function() {
            ...
            if ("number" == typeof e && e >= 0) {
                ...
                $ = u(function() {
                    ...
                    Be(e) && (Ue(), q.deactivated = null, Ke.emit({
                        type: "error",
                        name: "swf-not-found"
                    }))
                },
